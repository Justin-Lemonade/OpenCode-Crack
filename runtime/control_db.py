...
from src.config import CONTROL_DB_PATH
from src.runtime.agent_profile import AgentProfile
from src.storage.migrations import Migration, migrate
...
def heartbeat_agent_leases(agent_id: str, db_path: Path = CONTROL_DB_PATH) -> int:
    ...
    with _connect(db_path) as conn:
        ...
        return cur.rowcount
from src.orchestrator.task_board import release_task, block_task
