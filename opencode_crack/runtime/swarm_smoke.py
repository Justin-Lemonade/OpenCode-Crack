...
from opencode_crack.config import SWARM_SMOKE_MODEL, SWARM_SMOKE_TIMEOUT
...
from opencode_crack.runtime.swarm_normalize import normalize_swarm_result
...
def _default_endpoint() -> str:
    from opencode_crack.config import OPENCODE_BASE_URL
