...
from opencode_crack.orchestrator.knowledge_parser import KNOWLEDGE_DIR, parse_knowledge
...
def _write_board(entries: list) -> None:
    from opencode_crack.orchestrator import knowledge_report
...
def _git_publish(message: str, extra_paths: Optional[list] = None) -> bool:
    ...
    from opencode_crack.orchestrator.knowledge_report import BOARD_MD_PATH
...
from opencode_crack.orchestrator import durable_knowledge as _durable
