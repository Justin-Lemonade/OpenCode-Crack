...
def render_markdown(tasks: list) -> str:
    from opencode_crack.orchestrator.task_board import is_stale  # local import avoids a circular import
...
def _recent_activity() -> str:
    ...
    from opencode_crack.orchestrator.task_board import ACTIVITY_LOG
