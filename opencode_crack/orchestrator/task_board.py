...
from opencode_crack.orchestrator.task_parser import parse_roadmap
...
def _now() -> str:
    from opencode_crack.orchestrator.timestamps import now as _shared_now
    return _shared_now()
...
def _validate_timestamp_format(task_id: str, field: str, value: Optional[str]) -> None:
    ...
    """
    from opencode_crack.orchestrator.timestamps import validate_timestamp_format as _shared_validate
...
def _git_publish(message: str, extra_paths: Optional[list] = None) -> bool:
    ...
    from opencode_crack.orchestrator.status_report import STATUS_PATH
